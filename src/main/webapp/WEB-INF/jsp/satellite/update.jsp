...
<div class='card-body'>
					...
					<form:form modelAttribute="update_satellite_attr" method="post"
						...
						<div class="col-md-6">
							...
							<spring:bind path="denominazione">
								<input type="text" name="denominazione" id="denominazione"
									...
									value="${update_satellite_attr.denominazione }" required>
							</spring:bind>
						...
						<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date'
							value='${update_satellite_attr.dataRientro}' />
						<div class="col-md-3">
