				                	...
				                	<c:forEach items="${satellite_list_attribute }" var="satelliteItem">
										<tr>
											...
											<td>
												...
												<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/satellite/infoupdate/${satelliteItem.id}">Edit</a>
												<a class="btn btn-outline-danger btn-sm" href="${pageContext.request.contextPath}/satellite/remove/${satelliteItem.id}">Delete</a>
											</td>
										</tr>
									</c:forEach>
				                </tbody>
